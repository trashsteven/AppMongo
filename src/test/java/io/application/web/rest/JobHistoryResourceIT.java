...
import io.application.AppMongoApp;
import io.application.domain.JobHistory;
import io.application.repository.JobHistoryRepository;
import io.application.service.JobHistoryService;
...
import static io.application.web.rest.TestUtil.createFormattingConversionService;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import io.application.domain.enumeration.Language;
/**
 * Integration tests for the {@Link JobHistoryResource} REST controller.
 */
@SpringBootTest(classes = AppMongoApp.class)
